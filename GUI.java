...
public class GUI implements ActionListener {
    ...
    private void makeFrame() {
        ...
        display = new JTextField("" + (double) ((machine.getBalance()) / 100) + "0 €");
        ...
        addButton(buttonPanel, "Buy Snack");

        contentPane.add(buttonPanel, BorderLayout.CENTER);

        panel = new JPanel();
        message = new JLabel("For machine service push empty button 3x");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals(" ")) {
            ...
            if (command.equals("Show price")) {
                lowStr = "A snack costs " + (double) ((machine.getPrice()) / 100.0) + "0 €";
            }
                ...
                empty.setEnabled(false);
                machine.increaseService(-machine.checkService());
                upStr = "" + (double) ((machine.getBalance()) / 100) + "0 €";
            }

            else if (command.equals("Cancel")) {
                machine.returnMoney(machine.getBalance());
                upStr = "" + (double) ((machine.getBalance()) / 100) + "0 €";
                lowStr = machine.prompt();
            }

            else if (command.equals("Buy Snack")) {
